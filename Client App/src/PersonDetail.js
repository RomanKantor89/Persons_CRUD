...
class UserDetail extends Component {
  ...
  render() {
    document.title = `Person ${this.props._id} detail`;
    ...
    return (
      <div>
          ...
          <div className="row">
            <div className="col-md-6">
              <dl className="dl-horizontal">
                ...
                <dt>Birth date</dt><dd>{moment(u.birthDate).format('MM/DD/YYYY')}</dd>
        ...
        <hr />
        <p><Link className='btn btn-warning' to={`/persons/edit/${u._id}`}>Edit</Link>&nbsp;&nbsp;
